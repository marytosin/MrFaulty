...
<br><br><br>
<p align="center">
<b><font size="5" face="cambri">Reporters List</font></b></p>
...
String query = "select * from reporterdb";
...
%>
<tr align="center">
<td><%=rs.getString(1)%><br /><a href='delprep.jsp?id=<%=id%>'>Delete</a></td>
...
<p align="center">
<a href="newrep.jsp">Add New Reporter</a>
</body>
</html>